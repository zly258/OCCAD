...
/// <summary>
/// Shared metadata for the executable command surface. The catalog contains
/// only commands that are currently registered by <see cref="CadCoreRegistration"/>;
/// dormant implementations must not leave aliases or captions behind.
/// </summary>
...
internal static class CadCommandCatalog
{
    internal static readonly IReadOnlyDictionary<string, string[]> Aliases =
        new Dictionary<string, string[]>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["draw.point"] = ["POINT", "PO"],
            ["draw.line"] = ["LINE", "L"],
            ["draw.centerline"] = ["CENTERLINE", "CL"],
            ["draw.centermark"] = ["CENTERMARK", "CM"],
    ...
    internal static readonly IReadOnlyDictionary<string, (string Key, string Name)> Captions =
        new Dictionary<string, (string, string)>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["draw.centerline"] = ("Cad.Text.CenterLine", "Center Line"),
            ["draw.centermark"] = ("Cad.Text.CenterMark", "Center Mark"),
            ["draw.polyline"] = ("Cad.Text.Polyline", "Polyline"),
            ["draw.rectangle"] = ("Cad.Text.Rectangle", "Rectangle"),
            ["draw.polygon"] = ("Cad.Text.Polygon", "Polygon"),
            ["draw.regularpolygon"] = ("Cad.Text.RegularPolygon", "Regular Polygon"),
            ["draw.spline"] = ("Cad.Text.Spline", "Spline"),
            ["draw.circle"] = ("Cad.Text.Circle", "Circle"),
            ...
            ["draw.ellipse"] = ("Cad.Text.Ellipse", "Ellipse"),
