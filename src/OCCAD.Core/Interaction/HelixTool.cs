...
public sealed class HelixTool : CadDrawingTool, ICadPointInputTool
{
    ...
    protected override bool OnFinish() { if (!CanFinish) return false; CommitPreview(new CadHelixEntity(_origin, _axis, _xAxis, _radius, _pitch, _turns)); return true; }
