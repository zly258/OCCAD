...
internal static class CadTheme
{
    ...
    public static void Apply(Application app)
    {
        ...
        app.Styles.Add(new Style(x => x.OfType<TabControl>())
        {
            Setters =
            {
                new Setter(TabControl.BackgroundProperty, Toolbar),
                new Setter(TabControl.BorderThicknessProperty, new Thickness(0))
            }
        });
        ...
        app.Styles.Add(new Style(x => x.OfType<TabItem>())
        {
            Setters =
            {
                ...
                new Setter(TabItem.FontSizeProperty, 12.0),
                new Setter(TabItem.MinHeightProperty, 27.0),
                new Setter(TabItem.PaddingProperty, new Thickness(12, 4))
            }
        });
        ...
        app.Styles.Add(new Style(x => x.OfType<TabItem>().PropertyEquals(TabItem.IsSelectedProperty, true))
        {
            Setters =
            {
                new Setter(TabItem.ForegroundProperty, Accent),
        ...
        app.Styles.Add(new Style(x => x.OfType<Button>().Class("cad-ribbon-button"))
        {
            Setters =
            {
                new Setter(Button.MinHeightProperty, 23.0),
                new Setter(Button.FontSizeProperty, 11.0),
                new Setter(Button.PaddingProperty, new Thickness(5, 1)),
                new Setter(Button.MarginProperty, new Thickness(1)),
                new Setter(Button.BackgroundProperty, Brushes.White),
                new Setter(Button.BorderBrushProperty, Brush("#D0D7DE")),
                new Setter(Button.BorderThicknessProperty, new Thickness(1)),
                new Setter(Button.ForegroundProperty, Text),
        ...
        app.Styles.Add(new Style(x => x.OfType<Button>().Class("cad-ribbon-button").Class(":pointerover"))
        {
            Setters =
            {
                new Setter(Button.BackgroundProperty, Brush("#EBF2F7")),
                new Setter(Button.BorderBrushProperty, Accent)
            }
        });

        app.Styles.Add(new Style(x => x.OfType<Button>().Class("cad-ribbon-button").Class(":pressed"))
        {
            Setters =
            {
                new Setter(Button.BackgroundProperty, Brush("#D4E4F2")),
                new Setter(Button.BorderBrushProperty, Accent)
            }
        });

        app.Styles.Add(new Style(x => x.OfType<Button>().Class("cad-ribbon-button").Class(":disabled"))
        {
            Setters =
            {
                new Setter(Button.BackgroundProperty, Brush("#F5F6F7")),
                new Setter(Button.BorderBrushProperty, Brush("#E1E4E8")),
                new Setter(Button.ForegroundProperty, Brush("#959DA5"))
            }
        });

        app.Styles.Add(new Style(x => x.OfType<ToggleButton>().Class("cad-ribbon-toggle"))
        {
            Setters =
            {
                new Setter(ToggleButton.MinHeightProperty, 23.0),
                new Setter(ToggleButton.FontSizeProperty, 11.0),
                new Setter(ToggleButton.PaddingProperty, new Thickness(5, 1)),
                new Setter(ToggleButton.MarginProperty, new Thickness(1)),
                new Setter(ToggleButton.BackgroundProperty, Brushes.White),
                new Setter(ToggleButton.BorderBrushProperty, Brush("#D0D7DE")),
                new Setter(ToggleButton.BorderThicknessProperty, new Thickness(1)),
                new Setter(ToggleButton.ForegroundProperty, Text),
                new Setter(ToggleButton.CornerRadiusProperty, new CornerRadius(3))
            }
        });

        app.Styles.Add(new Style(x => x.OfType<ToggleButton>().Class("cad-ribbon-toggle").Class(":pointerover"))
        {
            Setters =
            {
                new Setter(ToggleButton.BackgroundProperty, Brush("#EBF2F7")),
                new Setter(ToggleButton.BorderBrushProperty, Accent)
            }
        });

        app.Styles.Add(new Style(x => x.OfType<ToggleButton>().Class("cad-ribbon-toggle").Class(":checked"))
        {
            Setters =
            {
                new Setter(ToggleButton.BackgroundProperty, AccentSoft),
                new Setter(ToggleButton.BorderBrushProperty, Accent),
                new Setter(ToggleButton.ForegroundProperty, Accent),
                new Setter(ToggleButton.FontWeightProperty, FontWeight.SemiBold)
            }
        });

        app.Styles.Add(new Style(x => x.OfType<Button>().Class("cad-category-header"))
        {
            Setters =
            {
                new Setter(Button.HeightProperty, 25.0),
                ...
                new Setter(Button.HorizontalContentAlignmentProperty, HorizontalAlignment.Stretch),
                new Setter(Button.VerticalContentAlignmentProperty, VerticalAlignment.Center),
                new Setter(Button.BackgroundProperty, Header),
                new Setter(Button.ForegroundProperty, Text),
                new Setter(Button.BorderBrushProperty, Border),
                new Setter(Button.BorderThicknessProperty, new Thickness(0, 1, 0, 1)),
                new Setter(Button.CornerRadiusProperty, new CornerRadius(0))
            }
        });

        app.Styles.Add(new Style(x => x.OfType<Button>().Class("cad-category-header").Class(":pointerover"))
        {
            Setters =
            {
                new Setter(Button.BackgroundProperty, HeaderHover)
            }
        });
